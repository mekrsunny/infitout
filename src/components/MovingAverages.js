  ...
  return (
    <div className="flex flex-col bg-white rounded">
      <div className="flex items-center justify-between px-10 py-4">
        <p className="font-bold">Moving Averages</p>
      ...
      <div className="w-auto mx-auto flex items-center gap-x-8 my-3">
        <div className="flex flex-col gap-y-2 items-center justify-center mx-5">
          <p>11</p>
          <p className=" text-yellow-500 bg-yellow-100 rounded px-2">Bearish</p>
        </div>
        <div className="flex flex-col gap-y-2 items-center justify-center mx-5">
          <p>2</p>
        ...
        <div className="flex flex-col gap-y-2 items-center justify-center mx-5">
          <p>4</p>
          <p className=" text-blue-400 bg-blue-100 rounded px-2">Bullish</p>
        </div>
      </div>
      <div className="w-full mx-auto flex flex-col gap-4 px-20">
        <div className="w-auto flex items-center justify-between">
          <div className="flex items-center justify-center space-x-3">
            <div className="bg-red-300 rounded flex items-center justify-center h-6 w-6">
